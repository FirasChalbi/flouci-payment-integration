...
<html lang="en">
<head>
    <title>Code coverage report for src/resources/customers/mandates.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/resources/customers</a> mandates.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  create(data, cb) {
    this.setParent(data);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof data === 'object') {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof params === 'object') {
